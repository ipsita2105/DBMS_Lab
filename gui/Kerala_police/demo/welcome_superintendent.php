...
<html>
   ...
   <body background="./images/super.jpg">
   <h1><center> <font face="Times New Roman"> Superintendent Homepage <?php echo $login_session; ?>
      </font> </center> </h1>
      <hr>
	<?php
		...
		<b><i><label for="ved"> View Employee Details  </label><br><br></b></i>
		<p>
		...
		<p>
                <input type="radio" name="history" value="data"> History <br><br>
                <input type="radio" name="pdetails" value="data"> Personal Details <br><br>
                <input type="radio" name="attend" value="data"> Attendance <br><br><br>
		</p>
	...
	<a href="http://localhost/Kerala_police/demo/insert_crime/insert_crime.html"><h3>
	Insert New Crime</h3></a><br>
